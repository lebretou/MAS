...
Key principle: Callbacks emit low-level execution events.
Do NOT infer agent_message from callbacks - use manual API for that.
"""
...
from mas_backbone.adapters.event_api import EventEmitter, EventSink
from mas_backbone.models.trace_event import EventType
from mas_backbone.utils.identifiers import generate_span_id
