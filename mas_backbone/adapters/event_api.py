...
from mas_backbone.utils.identifiers import generate_event_id, generate_span_id, utc_timestamp
...
class ListSink:
    """In-memory event sink that stores events in a list."""
...
class FileSink:
    """Event sink that writes events to a JSONL file."""
